...
class WaypointUpdater(object):
    ...
    def get_closest_waypoint_id(self):
        ...
        #checking if the closest waypoint is ahead or behind the vehicle
    ...
    def publish_waypoints(self):
        ...
        final_lane_waypoints = self.generate_lane_waypoints()
        self.final_waypoints_pub.publish(final_lane_waypoints)

    def generate_lane_waypoints(self):
        lane = Lane()
